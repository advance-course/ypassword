...
var _bezier_length_pool = require('./pooling/bezier_length_pool');

var _bezier_length_pool2 = _interopRequireDefault(_bezier_length_pool);

var _segments_length_pool = require('./pooling/segments_length_pool');
...
function bezFunction() {
  ...
  var getBezierLength = function () {
    return function (pt1, pt2, pt3, pt4) {
      var curveSegments = _index.defaultCurveSegments;
      var k = void 0;
      var i = void 0;
      var len = void 0;
      var ptCoord = void 0;
      ...
      var point = [];
      var lastPoint = [];
      var lengthData = _bezier_length_pool2.default.newElement();
      len = pt3.length;
  ...
  function getSegmentsLength(shapeData) {
    var segmentsLength = _segments_length_pool2.default.newElement();
  ...
  var buildBezierData = function () {
    ...
    return function (keyData) {
      ...
      len = pt3.length;
      for (k = 0; k < curveSegments; k += 1) {
        point = (0, _index.createSizedArray)(len);
        perc = k / (curveSegments - 1);
        ptDistance = 0;
        for (i = 0; i < len; i += 1) {
  ...
  var bezier_segment_points = (0, _index.createTypedArray)('float32', 8);
