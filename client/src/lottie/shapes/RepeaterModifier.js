...
var RepeaterModifier = function (_ShapeModifier) {
  ...
  function RepeaterModifier() {
    ...
    return _possibleConstructorReturn(this, (RepeaterModifier.__proto__ || Object.getPrototypeOf(RepeaterModifier)).apply(this, arguments));
  }
  ...
  _createClass(RepeaterModifier, [{
    ...
    value: function initModifierProperties(elem, data) {
      ...
      this.pMatrix = new _transformationMatrix2.default();
      this.rMatrix = new _transformationMatrix2.default();
      this.sMatrix = new _transformationMatrix2.default();
      this.tMatrix = new _transformationMatrix2.default();
      this.matrix = new _transformationMatrix2.default();
    }
  }, {
    key: 'applyTransforms',
...
exports.default = RepeaterModifier;